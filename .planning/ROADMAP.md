...
- [ ] 01-35-PLAN.md — G-01-7 capacity-aware supersede admission lever (WINDOWS 3, the session-11 over-rejection mode): free-slot capacity gate at the supersede call site + class-0 fully-receipted safe-reclaim class in the SHARED evictionClassOf (WINDOW_COMPLETE fullAcked evidence, no fork) + named discriminator line; WR-02 companion verified already-fixed upstream; builds + harness + PRI-01/protected-surface gates, no bench claims (CTRL-01, CTRL-03, CTRL-06, PRI-02)
