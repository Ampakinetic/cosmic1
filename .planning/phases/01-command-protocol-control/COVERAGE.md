...
Re-checked at the 01-26 gap-closure round (round-#11, 2026-08-28): the round's scope — review 7d96a98 finding routing (WINDOWS ledger entries 17-19), three small review-shaped robustness fixes in first-party firmware (capture-path PSRAM degradation fall-through, honest boot health-check branch, ACK-counter widening), and the 01-27 bench reflash — adds no external API surface. The declaration above stands unchanged.
